    ...
    try {
      ...
      usersSnap.forEach((doc) => {
        ...
        if (joinedAt) {
          const dayStr =
            timeframe === "7D"
              ? joinedAt.toLocaleDateString("en-US", { weekday: "short" })
              : joinedAt.getDate().toString();
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.timeframeToggle}>
          ...
          >
            <Text
              style={[styles.tfText, timeframe === "7D" && styles.tfTextActive]}
            >
              7D
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text
              style={[
                styles.tfText,
                timeframe === "30D" && styles.tfTextActive,
              ]}
            >
              30D
            </Text>
      ...
      >
            ...
            <View style={styles.chartWrapper}>
              ...
              <View style={StyleSheet.absoluteFill}>
                {[0, 1, 2, 3].map((i) => (
                  <View
                    key={i}
                    style={[styles.gridLine, { top: (200 / 3) * i }]}
                  />
                ))}
              </View>
              ...
              <View style={styles.barsRow}>
                {growthData.map((data, index) => {
                  const barHeight =
                    maxGraphValue === 0
                      ? 0
                      : (data.count / maxGraphValue) * 100;
                  return (
                    <View key={index} style={styles.barColumn}>
                      <View style={styles.tooltip}>
                        <Text style={styles.tooltipText}>{data.count}</Text>
                      </View>
        ...
        <View style={styles.insightCard}>
          ...
          <Text style={styles.insightDesc}>
            Based on the last {timeframe}, user acquisition is{" "}
            <Text style={{ fontWeight: "bold", color: "#10b981" }}>
              Healthy
            </Text>
            . However, only a small percentage of users are creating posts.
            Consider increasing EduCoin rewards for asking doubts to boost
            engagement.
          </Text>
        </View>
      </ScrollView>
