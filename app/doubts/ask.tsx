...
export default function AskDoubtScreen() {
  ...
  const handlePostDoubt = async () => {
    if (!title.trim() || !description.trim()) {
      Alert.alert(
        "Incomplete",
        "Please provide a title and description for your doubt.",
      );
      return;
    }
    ...
    if (
      ...
      Alert.alert(
        "Limit Exceeded",
        "Text limit exceeded! Please keep your doubt concise.",
      );
      return;
    }
    ...
    try {
      ...
      const reward =
        (await processAction(user.uid, "ASK_DOUBT")) ||
        (await processAction(user.uid, "CREATE_POST"));
            ...
            >
              {SUBJECTS.map((sub) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.subjectPill,
                    subject === sub && styles.activeSubjectPill,
                  ]}
                  onPress={() => {
                    setSubject(sub);
                ...
                >
                  <Text
                    style={[
                      styles.subjectText,
                      subject === sub && styles.activeSubjectText,
                    ]}
                  >
                    {sub}
                  </Text>
          ...
          <Animated.View entering={FadeInDown.delay(200).springify()}>
            <View style={styles.labelRow}>
              ...
              <Text
                style={[
                  styles.charCount,
                  title.length > MAX_TITLE_LENGTH - 20 && { color: "#ef4444" },
                ]}
              >
                {title.length}/{MAX_TITLE_LENGTH}
              </Text>
          ...
          <Animated.View entering={FadeInDown.delay(300).springify()}>
            <View style={styles.labelRow}>
              ...
              <Text
                style={[
                  styles.charCount,
                  description.length > MAX_DESC_LENGTH - 50 && {
                    color: "#ef4444",
                  },
                ]}
              >
              ...
              >
                ...
                <View style={{ marginLeft: 15 }}>
                  ...
                  <Text style={styles.uploadSub}>
                    Attach a screenshot of the question
                  </Text>
                </View>
              </TouchableOpacity>
            )}
