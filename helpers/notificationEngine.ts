...
export async function registerForPushNotificationsAsync(userId: string) {
  ...
  if (Platform.OS === 'web') {
    console.log('🌐 Web par Push Notifications abhi disabled hain. Please test on a real mobile device.');
  ...
  if (Device.isDevice) {
    ...
    console.log('📱 Must use a physical device for Push Notifications (Emulator pe nahi chalega)');
  }
